package classworks.dec262017.task17;

//2.Известны год, номер месяца и день рождения человека, а также год, номер месяца и день сегодняшшнего дня. Определить возраст
