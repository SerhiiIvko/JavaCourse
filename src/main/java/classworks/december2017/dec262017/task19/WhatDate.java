package classworks.december2017.dec262017.task19;

//4.Запросить у пользователя 3 значения: year, month, day. Определить:
//a.Дату предыдущего дня
//b.Дату следующего дня
//В обеих задачах рассмотреть два варианта:
//1.Заданный год не является високосным
//2.Может быть високосным (смотреть задачу 6)
